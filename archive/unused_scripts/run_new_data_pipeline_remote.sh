...
# Output subdirectories (matching what CompleteURLResolutionPipeline expects)
...
log "Browser Input: $BROWSER_INPUT"
log "Facebook Input: $FACEBOOK_INPUT"
...
# The pipeline expects base-dir containing browser_urlextract and facebook_urlextract
